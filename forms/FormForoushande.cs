...
{
    public partial class FormForoushande : Form
    {
        ...
        Foroushande foroushande;
 

        public FormForoushande()
        {
            InitializeComponent();
        }
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            catch
            {
                ...
                if (txt_userName.Text == "") txt_userName.Text = txt_email.Text; ;
                if (txt_password.Text != txt_password2.Text)
                {
                MessageBox.Show("رمز های عبور مطابقت ندارند");
                 error = true;   
                }
            ...
            if (!error)
            {
                ...
                foroushande = new Foroushande();
                foroushande.add(name, lastName, shomareShenasname, birthday, gender, email, telephoneSabet, telephoneHamrah, userName, password, address);
                showData();
                txt_name.Text = "";
                txt_family.Text = "";
        ...
        private void FormForoushande_Load(object sender, EventArgs e)
        {
            showData();
        }
        ...
        void showData()
        {
            ...
            objDataAdapter.SelectCommand.CommandText = "SELECT [user].id,name,lastName,shomareShenasname,birthday,gender,email,telephoneSabet,telephoneHamrah,address,userName,password FROM [user] JOIN [foroushande] ON [user].id = [foroushande].userId";
            ...
            dataGridView1.Columns[10].HeaderText = "نام کاربری";
            dataGridView1.Columns[11].HeaderText = "رمز عبور";
            ...
            try
            {
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    if (!error)
                    {
                        ...
                        userName = txt_userName.Text;
                        password = txt_password.Text;
                        foroushande.update(id, name, lastName, shomareShenasname, birthday, gender, email, telephoneSabet, telephoneHamrah, userName, password, address);
                        showData();
                        txt_name.Text = "";
                        txt_family.Text = "";
                        txt_shomareShenasname.Text = "";
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                txt_userName.Text = dataGridView1.SelectedRows[0].Cells[10].Value.ToString();
                txt_password.Text = dataGridView1.SelectedRows[0].Cells[11].Value.ToString();
