...
namespace ModiriatForoushgah.forms
{
    public partial class FormMoshtari : Form
    {
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            moshtari = new Moshtari();
            moshtari.add(name, lastName, shomareShenasname, birthday, gender, email, telephoneSabet, telephoneHamrah,bedehkar, bestankar, address);
                showData();
            txt_name.Text = "";
            txt_family.Text = "";
        ...
        void showData()
        {
            ...
            objDataAdapter.SelectCommand.CommandText = "SELECT [user].id,name,lastName,shomareShenasname,birthday,gender,email,telephoneSabet,telephoneHamrah,address,bedehkar,bestankar FROM [user] JOIN [moshtari] ON [user].id = [moshtari].userId";
        ...
        {bool error = false;
            ...
            if (!error)
            {
                ...
                bedehkar = txt_bedehkar.Text;
                bestankar = txt_bestankar.Text;
                moshtari.update(id, name, lastName, shomareShenasname, birthday, gender, email, telephoneSabet, telephoneHamrah, bedehkar, bestankar, address);
                showData();
                txt_name.Text = "";
                txt_family.Text = "";
                txt_shomareShenasname.Text = "";
