...
{
    public partial class FormAnbardar: Form
    {
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            if (!error)
            {
                ...
                anbardar = new Anbardar();
                anbardar.add(name, lastName, shomareShenasname, birthday, gender, email, telephoneSabet, telephoneHamrah, userName, password, address);
                showData();
                txt_name.Text = "";
                txt_family.Text = "";
        ...
        private void FormAnbardar_Load(object sender, EventArgs e)
        {
            showData();
        }
        ...
        void showData()
        {
            ...
            objDataAdapter.SelectCommand.CommandText = "SELECT [user].id,name,lastName,shomareShenasname,birthday,gender,email,telephoneSabet,telephoneHamrah,address,userName,password FROM [user] JOIN [anbardar] ON [user].id = [anbardar].userId";
            ...
            try
            {
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    if (!error)
                    {
                        ...
                        userName = txt_userName.Text;
                        password = txt_password.Text;
                        anbardar.update(id, name, lastName, shomareShenasname, birthday, gender, email, telephoneSabet, telephoneHamrah, userName, password, address);
                        showData();
                        txt_name.Text = "";
                        txt_family.Text = "";
                        txt_shomareShenasname.Text = "";
